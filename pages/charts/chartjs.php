...
<html lang="en">
  ...
  <body>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Tendances </h3>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title"> Bénéfice Journalière</h4>
                    <table class="table table-bordered">
                      <thead>
                        <tr>
                          <th> N° </th>
                          <th> Bénéfice Crédit </th>
                          <th> Bénéfice Carte </th>
                          <th> Shop </th>
                          <th>Rapport</th>
                          <th> Date </th>
                        </tr>
                      ...
                      <tbody>
                        <tr>
                          <td> 1 </td>
                          <td class="Benefice-Credit">kjfkf</td>
                          <td class="Bénéfice-Carte">kfkf</td>
                          <td class="Banunu">dkfkf</td>
                          <td>
                            chd
                          </td>
                          <td> 01/01/2024</td>
    ...
    <script>
      function updateProfit(selectElement) {
        var selectedOption = selectElement.options[selectElement.selectedIndex];
        var creditProfitCell = selectElement.parentElement.parentElement.querySelector('.Benefice-Credit');
        var cardProfitCell = selectElement.parentElement.parentElement.querySelector('.Bénéfice-Carte');
        var creditProfit = selectedOption.getAttribute("data-credit-profit");
        var cardProfit = selectedOption.getAttribute("data-card-profit");
        var NomDuShop = selectedOption.value;
        creditProfitCell.textContent = creditProfit + " U (" + NomDuShop + ")";
        cardProfitCell.textContent = cardProfit + " U (" + NomDuShop + ")";
      }
    </script>
  </body>
</html>